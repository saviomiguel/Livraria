...
<head>
    ...
    <title>Redefinir Senha - Livraria</title>
    <!-- Bootstrap CSS -->
                ...
                <div class="reset-container text-center">
                    ...
                    <form method="POST" action="{{ route('password.store') }}">
                        ...
                        <div class="mb-3 text-start">
                            ...
                            <input id="email" type="email" name="email" class="form-control" required autofocus autocomplete="username" value="{{ old('email', $request->email) }}">
                        ...
                        <button type="submit" class="btn btn-light w-100">Redefinir Senha</button>
                    </form>
                </div>
            </div>
        </div>
